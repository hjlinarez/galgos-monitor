...
function MiniJackpot({ sorteo }) {
  ...
  return (<>
    ...
    <div className={`card ${styles.borde_dorado}`}>
      <div className={`card-header text-center p-0 fs-4 fw-bold ${styles.card_header_jackpot}`}>Mini Jackpot</div>
      <div className="card-body p-0 m-0">
        <div className={`${styles.card_body_jackpot}`}>{jackpot.mini.toLocaleString("es-VE")}</div>
      </div>
    </div>
  </>)
}

export default MiniJackpot